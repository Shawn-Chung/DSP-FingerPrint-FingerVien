...
const  char OV7670_reg[CHANGE_REG_NUM][2] ;
extern uint8_t		interrupt_flag ;
extern uint8_t		Is_CMOS_Write_End ;
...
void cmos_OV7670_init(void)//
{
	unsigned int i=0;
	Is_CMOS_Write_End = 0 ;
	VISUAL_I2C_ON ;
	write_cmos_sensor(0x12, 0X80); //Reset SCCB
	_delay_ms(50);
    for(i=0;i<CHANGE_REG_NUM;i++)
	{
		write_cmos_sensor(OV7670_reg[i][0],OV7670_reg[i][1]) ;
	}
	Is_CMOS_Write_End = 1 ;
}
...
const  char OV7670_reg[CHANGE_REG_NUM][2]=
{
	...
	{0x89, 0xe8},
	{0x13, 0xe0},
	{0x00, 0x00},//{0x00, 0x0f},//AGC 0F
	{0x10, 0x00},
	{0x0d, 0x00},
	{0x14, 0x28},//{0x14, 0x38},//0x38, limit the max gain
	{0xa5, 0x05},
	{0xab, 0x07},
	{0x24, 0x75},
	{0x25, 0x63},
